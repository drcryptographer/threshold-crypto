...
var file_proto_thresholdagent_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x61, 0x74, 0x65, 0x22, 0x68, 0x0a, 0x10, 0x53, 0x63, 0x68, 0x6e, 0x6f, 0x72, 0x72,
	0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x53, 0x65, 0x73,
	...
	0x72, 0x49, 0x64, 0x12, 0x0c, 0x0a, 0x01, 0x52, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x01,
	0x52, 0x12, 0x0c, 0x0a, 0x01, 0x53, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x01, 0x53, 0x22,
...
var file_proto_thresholdagent_proto_depIdxs = []int32{
	...
	4,  // 3: thresholdagent.SchnorrRound1MsgList.messages:type_name -> thresholdagent.SchnorrRound1Msg
	5,  // 4: thresholdagent.SchnorrRound2MsgList.messages:type_name -> thresholdagent.SchnorrRound2Msg
	6,  // 5: thresholdagent.SchnorrRound3MsgList.messages:type_name -> thresholdagent.SchnorrRound3Msg
	0,  // 6: thresholdagent.ResultMsg.status:type_name -> thresholdagent.Status
	7,  // 7: thresholdagent.ThresholdAgent.Authenticate:input_type -> thresholdagent.AuthRequest
	2,  // 8: thresholdagent.ThresholdAgent.DkgSchnorrRound1:input_type -> thresholdagent.SchnorrRound0Msg
	10, // 9: thresholdagent.ThresholdAgent.DkgSchnorrRound2:input_type -> thresholdagent.SchnorrRound1MsgList
	11, // 10: thresholdagent.ThresholdAgent.DkgSchnorrRound3:input_type -> thresholdagent.SchnorrRound2MsgList
	13, // 11: thresholdagent.ThresholdAgent.DkgSchnorrRoundFinal:input_type -> thresholdagent.ResultMsg
	2,  // 12: thresholdagent.ThresholdAgent.SchnorrSignRound1:input_type -> thresholdagent.SchnorrRound0Msg
	10, // 13: thresholdagent.ThresholdAgent.SchnorrSignRound2:input_type -> thresholdagent.SchnorrRound1MsgList
	11, // 14: thresholdagent.ThresholdAgent.SchnorrSignRound3:input_type -> thresholdagent.SchnorrRound2MsgList
	12, // 15: thresholdagent.ThresholdAgent.SchnorrSignRound4:input_type -> thresholdagent.SchnorrRound3MsgList
	8,  // 16: thresholdagent.ThresholdAgent.Authenticate:output_type -> thresholdagent.AuthResponse
	4,  // 17: thresholdagent.ThresholdAgent.DkgSchnorrRound1:output_type -> thresholdagent.SchnorrRound1Msg
	11, // 18: thresholdagent.ThresholdAgent.DkgSchnorrRound2:output_type -> thresholdagent.SchnorrRound2MsgList
	6,  // 19: thresholdagent.ThresholdAgent.DkgSchnorrRound3:output_type -> thresholdagent.SchnorrRound3Msg
	13, // 20: thresholdagent.ThresholdAgent.DkgSchnorrRoundFinal:output_type -> thresholdagent.ResultMsg
	4,  // 21: thresholdagent.ThresholdAgent.SchnorrSignRound1:output_type -> thresholdagent.SchnorrRound1Msg
	11, // 22: thresholdagent.ThresholdAgent.SchnorrSignRound2:output_type -> thresholdagent.SchnorrRound2MsgList
	6,  // 23: thresholdagent.ThresholdAgent.SchnorrSignRound3:output_type -> thresholdagent.SchnorrRound3Msg
	9,  // 24: thresholdagent.ThresholdAgent.SchnorrSignRound4:output_type -> thresholdagent.SchnorrSignature
