...
type SignRequest struct {
	...
	MessageBody *thresholdagent.MessageBody  `protobuf:"bytes,5,opt,name=message_body,json=messageBody,proto3" json:"message_body,omitempty"`
}
...
func (x *SignRequest) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *SignRequest) GetMessageBody() *thresholdagent.MessageBody {
	if x != nil {
...
var file_proto_maestro_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xfc, 0x01, 0x0a, 0x0b, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x65,
	...
	0x74, 0x61, 0x6d, 0x70, 0x12, 0x3e, 0x0a, 0x0c, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f,
	0x62, 0x6f, 0x64, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74, 0x68, 0x72,
	0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x42, 0x6f, 0x64, 0x79, 0x52, 0x0b, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x42, 0x6f, 0x64, 0x79, 0x22, 0x99, 0x01, 0x0a, 0x0c, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x65, 0x73,
...
var file_proto_maestro_proto_goTypes = []interface{}{
	...
	(*thresholdagent.MessageBody)(nil), // 7: thresholdagent.MessageBody
}
var file_proto_maestro_proto_depIdxs = []int32{
	...
	7, // 5: maestro.SignRequest.message_body:type_name -> thresholdagent.MessageBody
	4, // 6: maestro.SignResponse.sType:type_name -> thresholdagent.SignatureType
	0, // 7: maestro.ThresholdMaestro.DistributedKeyGen:input_type -> maestro.Request
	2, // 8: maestro.ThresholdMaestro.Sign:input_type -> maestro.SignRequest
	1, // 9: maestro.ThresholdMaestro.DistributedKeyGen:output_type -> maestro.Response
	3, // 10: maestro.ThresholdMaestro.Sign:output_type -> maestro.SignResponse
